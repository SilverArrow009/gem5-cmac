...
main()
{
    ...
    __asm__ volatile("li a0, 4\n"
                     ...
                     // Real: (s1_r*s2_r - s1_i*s2_i) - d_r = (s1_r*s2_r - d_r) - s1_i*s2_i
                     "vfmsac.vv v14, v10, v12\n"
                     "vfnmsac.vv v14, v11, v13\n"

                     // Imag: (s1_r*s2_i + s1_i*s2_r) - d_i = (s1_r*s2_i - d_i) + s1_i*s2_r
                     "vfmsac.vv v15, v10, v13\n"
